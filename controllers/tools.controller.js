...
const GENERATORS = {
  ...
  website_creation:    (i) => aiService.generateWebsiteCreation(i),
...
const TOOL_LABELS = {
  ...
  business_plan: 'Business Plan', competitor_matrix: 'Competitor Analysis',
  pricing_calculator: 'Pricing Strategy', launch_roadmap: '30-Day Launch Roadmap',
  contract: 'Contract Agreement', budget_estimator: 'Budget Estimator',
  pitch_deck: 'Investor Pitch Deck', ad_copy: 'Multi-Platform Ad Copy',
  seo_keywords: 'SEO Keyword Map', content_calendar: '30-Day Content Calendar',
  market_study: 'Market Study', cold_email: 'Cold Email Sequence',
...
exports.generate = async (req, res) => {
  try {
    ...
    if (!GENERATORS[toolType]) return res.status(400).json({ error: 'Unknown tool type' });
